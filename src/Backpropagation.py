...
if __name__ == '__main__':
    ...
    # Create data loaders
    LC_dataset = data_loader.MaskedDataset(data_loader.LIVECELL_IMG_DIR, data_loader.LIVECELL_MASK_DIR, length=10, in_memory=False, return_domain_identifier=True, augmented=True)
    test_dataset = data_loader.MaskedDataset(data_loader.TEST_IMG_DIR, data_loader.TEST_MASK_DIR, length=10, in_memory=False, return_domain_identifier=False)
    '''
    # Mixed data
